...
function TerminalWindow() {
  ...
  const commandMap = useMemo(
    () => ({
      ...
      whoami: ['ermiyas_kifle — engineer & designer, Vienna VA'],
      stack: ['python, django, react, typescript, postgresql, aws (ec2/rds/s3), docker'],
      projects: ['3 projects: DegreeCycle Technologies, GriotBot Corp, FuelStop LLC'],
      skills: ['python, javascript, typescript, sql, bash, django, react, aws, docker, figma, openai api'],
      contact: ['ermimesfin@yahoo.com', 'linkedin: linkedin.com/in/ermi-kifle-69443a195'],
      date: [new Date().toString()],
      matrix: ['Wake up, Ermiyas... The matrix has you.'],
